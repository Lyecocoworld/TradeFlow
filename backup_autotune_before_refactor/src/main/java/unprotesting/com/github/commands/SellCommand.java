...
import unprotesting.com.github.commands.core.BaseCommand; // Import BaseCommand
...
public class SellCommand extends BaseCommand { // Extend BaseCommand
    ...
    public SellCommand(@NotNull AutoTune plugin) {
        super(plugin, "atsell", "autotune.command.sell", "Open a panel to sell items.", "/atsell");
        setPlayerOnly(true);
    }
        ...
        gui.setOnClose(event -> {
            ...
            for (ItemStack item : gui.getInventory().getContents()) {
                ...
                if (amountToSell > 0) {
                    ...
                    ShopUtil.addTransaction(transaction);
                }
            }
