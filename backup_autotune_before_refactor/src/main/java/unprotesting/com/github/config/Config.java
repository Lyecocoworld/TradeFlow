...
public class Config {
    ...
    @Getter private final String defaultCollectFirst;
    ...
    @Getter private final String notUnlocked;
    ...
    @Getter private final String loreStatusUnlocked;
    @Getter private final String loreStatusLocked;
    ...
    private Config() {
        ...
        this.defaultCollectFirst = configs[0].getString("default-collect-first", "player");
        logger.finer("Default Collect First: " + defaultCollectFirst);
        ...
        this.loreStatusUnlocked = configs[3].getString("lore-status-unlocked");
        logger.finest("Lore Status Unlocked: " + loreStatusUnlocked);
        this.loreStatusLocked = configs[3].getString("lore-status-locked");
        logger.finest("Lore Status Locked: " + loreStatusLocked);
