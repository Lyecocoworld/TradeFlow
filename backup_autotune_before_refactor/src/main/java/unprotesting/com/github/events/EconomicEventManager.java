...
import unprotesting.com.github.config.EventsConfig;
import unprotesting.com.github.database.ServerStateData;
...
public class EconomicEventManager {
    ...
    public EconomicEventManager(AutoTune plugin, ServerStateData serverStateData) {
        this.plugin = plugin;
