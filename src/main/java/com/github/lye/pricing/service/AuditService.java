...
public interface AuditService {
     ...
     */
    void auditStartup(Map<ItemId, com.github.lye.pricing.model.ItemConfig> itemConfigs, List<Recipe> allRecipes, List<Recipe> filteredRecipes, List<ItemId> unpriceableItems);
    ...
    void auditInvalidAnchors(java.util.Map<com.github.lye.pricing.model.ItemId, com.github.lye.pricing.model.ItemConfig> itemConfigs);
    void auditInfinitePrices(com.github.lye.pricing.model.PriceSnapshot priceSnapshot);
