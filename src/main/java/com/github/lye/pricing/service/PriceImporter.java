...
public interface PriceImporter {
     ...
     */
    CompletableFuture<Void> initialSeed(PriceSnapshot calculatedPrices, Map<ItemId, com.github.lye.pricing.model.ItemConfig> itemConfigs);
     ...
     */
    CompletableFuture<Void> updatePrices(PriceSnapshot newPrices, PriceSnapshot oldPrices, Map<ItemId, com.github.lye.pricing.model.ItemConfig> itemConfigs);
