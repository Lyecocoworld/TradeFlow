...
import com.github.lye.pricing.service.PricingUtils;
...
public class ConfigLoader {
    ...
    public Map.Entry<Map<com.github.lye.pricing.model.ItemId, ItemConfig>, GlobalPricingConfig> load(String fileName) {
        ...
        try {
            ...
            Map<com.github.lye.pricing.model.ItemId, ItemConfig> itemConfigs = new HashMap<>();
            if (rawConfig.containsKey("items")) {
                ...
                for (Map.Entry<String, Object> entry : shopsSection.entrySet()) {
                    ...
                    com.github.lye.pricing.model.ItemId itemId = new com.github.lye.pricing.model.ItemId(itemIdString);
                    ...
                    com.github.lye.pricing.model.PricingLocal pricingLocal = new com.github.lye.pricing.model.PricingLocal(m, t, pmin, pmax, volatility);
